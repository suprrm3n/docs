...
<AccordionGroup>
  ...
  <Accordion title="Are my messages end-to-end encrypted?">
    Tavrn messages are encrypted in transit and at rest using Supabase's encryption standards. They are not end-to-end encrypted in the same way as Signal or similar apps.
  </Accordion>
</AccordionGroup>
